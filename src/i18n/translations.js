export const translations = {
  zh: {
    ...
    product: {
      title1: "四大战略价值主张",
      title2: "驱动企业AI转型",
      subtitle: "通过五大核心能力的协同，实现卓越运营效率、专家能力规模化复制、大规模超个性化服务和可持续的生成式扩张，构建难以复制的长期竞争壁垒。",
      features: [
        { title: "专家能力规模化复制", desc: "通过AI技术固化并复制顶尖专家的隐性知识，提升团队平均水平" },
        { title: "规模化超个性化服务", desc: "基于强大的客户数据智能，实现千人千面的个性化客户体验" },
        { title: "可持续生成式扩张", desc: "内置风险管控的生成式AI，保障大规模内容创作的业务安全" }
      ],
      cta: {
        primary: "免费试用",
        note: "无需绑定支付信息"
    ...
    useCases: {
      title1: "核心产品与解决方案",
      title2: "从对话到创作的完整生态",
      subtitle: "基于五大核心能力构建的旗舰产品，为企业提供从智能对话到内容创作的端到端AI解决方案",
      cases: [
        {
          title: "销售AI助手生态系统",
          description: "整合多项核心能力的智能销售平台，从对话到转化的完整闭环",
          features: [
            "长程上下文对话管理",
            "顾问式营销话术模型",
            "动态知识库与智能检索",
        ...
        {
          title: "AI视频创作平台",
          description: "生成式AI领域的旗舰产品，三层架构的视频批量创作",
          features: [
            "感知-决策-执行三层架构",
            "AI驱动的创意编排",
            "同质化检测风险管理",
        ...
        {
          title: "专业化智能体矩阵",
          description: "快速响应特定业务需求的定制化AI解决方案",
          features: [
            "AI渠道分析智能体",
            "AI老板知识库",
            "项目AI助手",
        ...
        {
          title: "企业级RAG知识体系",
          description: "构建企业智能大脑，实现知识资产的智能化管理",
          features: [
            "动态知识库管理",
            "高精度信息检索",
            "个性化风格合成",
