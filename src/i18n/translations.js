export const translations = {
  zh: {
    ...
    hero: {
      ...
      title1: "开创中国AI智能营销",
      title2: "新范式",
      subtitle: "致力于在企业应用与经营式AI技术之间架起桥梁，通过专业的AI智能化部署服务，为企业提供从POC验证到正式实施的完整解决方案，推动中国AI智能营销的创新发展。",
      ctaPrimary: "免费试用",
      ctaSecondary: "观看演示",
      stats1: { value: "100+", label: "企业级解决方案" },
      stats2: { value: "500+", label: "规模化部署" },
      stats3: { value: "99%", label: "业务价值转化" },
    ...
    product: {
      title1: "AI智能营销",
      title2: "解决方案矩阵",
      subtitle: "从AI客服到智能营销，从数据分析到企业管理，提供全方位的AI智能化部署服务，助力企业实现营销数字化转型升级。",
      features: [
        { title: "AI客服系统", desc: "智能客户服务解决方案，提升客户满意度和服务效率" },
        { title: "智能营销平台", desc: "AI驱动的精准营销，实现个性化客户触达和转化" },
        { title: "数据分析工具", desc: "智能数据分析与洞察，为业务决策提供科学依据" }
      ],
      cta: {
        primary: "免费试用",
        note: "专业AI部署服务"
    ...
    features: {
      ...
      items: [
        { title: "智能交互与对话系统", desc: "长程上下文对话引擎、多模态理解、顾问式营销话术模型，复制金牌销售的专业沟通能力" },
        { title: "知识智能与RAG", desc: "动态知识库管理、高精度信息检索、个性化风格合成，构建企业智能大脑" },
        { title: "客户数据智能与超个性化", desc: "端到端客户画像系统，形成数据驱动的策略迭代闭环，实现千人千面服务" },
        { title: "生成式AI与多模态内容创作", desc: "感知-决策-执行三层架构，AI驱动的创意编排，内置同质化风险管理确保业务安全" },
        { title: "企业自动化与工作流编排", desc: "无缝集成企业微信/飞书，低代码AI工作流，智能化营销销售流程自动化" },
        { title: "安全与合规", desc: "数据隔离与加密、RBAC权限控制、审计追踪，企业级安全治理体系" }
      ],
    ...
    resources: {
      header1: "深度了解",
      header2: "五大核心能力体系",
      desc: "从智能交互到风险管控，从客户画像到工作流编排：完整的方法论与实战案例分享。",
      categories: {
        all: "全部",
        capabilities: "核心能力",
        cases: "成功案例",
      ...
      list: {
        guide: { type: "白皮书", title: "熵变智元AI能力矩阵：战略分析与综合报告", desc: "深度解析五大核心能力支柱及其协同效应，揭示企业AI转型的战略路径。", read: "30 分钟阅读", category: "方法论" },
        video: { type: "案例研究", title: "销售AI助手生态：3倍转化率提升实录", desc: "顾问式对话+客户画像+自动化触达的完整解决方案落地过程。", read: "20 分钟观看", category: "成功案例" },
        template: { type: "技术指南", title: "企业级RAG部署与风险管控最佳实践", desc: "从动态知识库到同质化检测，构建可持续的生成式AI平台。", read: "免费下载", category: "实施指南" },
        readmore: "了解更多",
    ...
    testimonials: {
      header1: "客户成功案例",
      header2: "见证AI价值转化",
      subtitle: "从初创企业到大型集团，熵变智元以五大核心能力驱动客户业务增长，实现可衡量的价值创造。",
      stats: {
        s1: "企业客户",
        s2: "运营效率提升",
        s3: "业务价值转化",
      ...
      items: [
        {
          ...
          role: "销售总监",
          company: "科技服务企业",
          content: "销售AI助手的顾问式对话让我们的转化率提升了3倍，客户画像系统实现了真正的千人千面服务。",
          rating: 5
        },
        {
          name: "李经理",
          role: "市场营销负责人",
          company: "内容营销公司",
          content: "AI视频创作平台的同质化风险管理让我们敢于大规模生产内容，业务安全得到完全保障。",
          rating: 5
        },
        {
          name: "王主管",
          role: "运营主管",
          company: "电商企业",
          content: "企业级RAG系统让我们的知识资产活了起来，员工能快速获取准确信息，工作效率提升显著。",
          rating: 5
        },
        {
          name: "陈总",
          role: "创始人",
          company: "初创企业",
          content: "低代码AI工作流让我们快速部署了多个智能体，人工智能能力快速落地，投资回报率超出预期。",
          rating: 5
        }
      ]
    },
    footer: {
      topTitle1: "开创中国AI智能营销",
      topTitle2: "新范式", 
      topDesc: "专业的AI智能化部署服务，助力企业实现从传统营销到智能营销的完美转型。",
      topPrimary: "免费开始",
      topSecondary: "联系销售",
      product: "产品",
      company: "公司",
    ...
    useCases: {
      ...
      cases: [
        {
          title: "AI客服系统",
          description: "智能客户服务解决方案，提升服务效率和客户满意度",
          features: [
            "智能对话机器人",
            "多渠道客服集成", 
            "知识库智能检索",
        ...
        {
          title: "智能营销平台",
          description: "AI驱动的精准营销解决方案，实现个性化客户触达",
          features: [
            "客户画像智能分析",
            "营销内容自动生成",
            "精准投放策略优化",
        ...
        {
          title: "数据分析工具",
          description: "智能数据分析与洞察，为业务决策提供科学依据",
          features: [
            "多维数据可视化",
            "智能趋势预测",
            "异常检测告警",
    ...
    pricing: {
      title1: "投资回报驱动的",
      title2: "企业级AI解决方案", 
      subtitle: "基于五大核心能力的价值主张，为不同规模企业提供可衡量ROI的AI转型路径",
      ...
      mostPopular: "最受欢迎",
      allPlansInclude: "所有企业版计划均包含",
      allPlansDesc: "五大核心能力确保您的AI转型成功",
      faq: {
        title: "企业关心的问题",
        items: [
          { q: "五大核心能力如何协同工作？", a: "智能交互提供前端体验，RAG构建知识底座，客户数据智能驱动个性化，生成式AI产出内容，自动化确保落地执行，形成完整闭环。" },
          { q: "如何确保AI生成内容的安全性？", a: "我们内置同质化检测和风险管控系统，主动规避平台风险，保障企业业务安全和可持续运营。" },
          { q: "支持哪些企业生态集成？", a: "原生支持企业微信、飞书等主流办公平台，通过低代码工作流快速集成现有业务系统。" },
          { q: "如何衡量AI投资的回报率？", a: "我们提供详细的ROI效果分析，包括运营效率提升、成本节约、转化率改善等可量化指标。" }
        ]
      },
      haveQuestions: "需要定制化方案？",
      salesTeam: "我们的解决方案专家随时为您规划AI转型路径",
      contactSales: "咨询专家",
      viewFAQ: "查看更多问题",
      features: [
        "五大核心能力完整体系",
  ...
  en: {
    ...
    footer: {
      topTitle1: "Write",
      topTitle2: "something good",
      topDesc: "Trusted by teams. Start your journey today.",
      topPrimary: "Start free",
      topSecondary: "Contact sales",
      product: "Product",
      company: "Company",
      resources: "Resources",
      legal: "Legal",
